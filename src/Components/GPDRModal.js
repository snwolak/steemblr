...
export default class PrivacyPolicy extends Component {
  ...
  handleAccept = () => {
    localStorage.setItem("gpdrAccepted", true);
    this.setState({
      isOpen: false
    });
  };
    ...
    return (
      <Modal isOpen={isOpen}>
        <Container>
          ...
          <p>Effective date: February 06, 2019</p>

          <p>
            steemblr.com ("us", "we", or "our") operates the
            https://steemblr.com/ website (the "Service").
          </p>
          ...
          <p>steemblr.com uses the collected data for various purposes:</p>
          <ul>
          ...
          <p>
            steemblr.com will take all steps reasonably necessary to ensure that
          ...
          <p>
            steemblr.com may disclose your Personal Data in the good faith
            belief that such action is necessary to:
          </p>
          <ul>
            <li>To comply with a legal obligation</li>
            <li>
              To protect and defend the rights or property of steemblr.com
            </li>
            <li>
          ...
          <ul>
            <li>
              By visiting this page on our website: https://discord.gg/hHmZgk6
            </li>
          </ul>
        </Container>
