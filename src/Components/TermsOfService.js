  ...
  render() {
    return (
      <div>
        <h2>
          Terms of Service of{" "}
          <span class="website_url">https://steemblr.com/</span>
        </h2>

        <p>
          <span class="website_name">steemblr.com</span> ("Us" or "We") provides
          the <span class="website_url">https://steemblr.com/</span> website and
          various related services (collectively, the "Website") to you, the
          User, subject to your compliance with all the terms, conditions, and
          notices contained or referenced herein (the "Terms of Service"), as
        ...
        <p>
          ...
          <span class="date">Jan 2019</span>. We expressly reserve the right to
          change these Terms of Service from time to time without notice to you.
          You acknowledge and agree that it is your responsibility to review
          this Website and these Terms of Service from time to time and to
        ...
        <p>
          ...
          under copyright of <span class="website_name">steemblr.com</span> or
          its Affiliates. All other marks are property of their respective
          owners. Nothing in these Terms of Service grants you any right to use
          any trademark, service mark, logo, and/or the name or trade names of{" "}
          <span class="website_name">steemblr.com</span> or its Affiliates.
        </p>
        ...
        <p>
          ...
          <span class="website_name">steemblr.com</span> spokesperson speaking
          in his/her official capacity. Please refer to the specific editorial
        ...
        <p>
          ...
          the internal laws of the <span class="country">pl</span> without
        ...
        <p>
          ...
          in the federal courts of <span class="country">pl</span>.
        </p>
      </div>
    );
  }
