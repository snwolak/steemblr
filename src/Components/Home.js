      ...
      >
        <Box width={1 / 2} p={3}>
          <Card>
            ...
            >
              <Heading f={[4, 5, 6, 7]}>Ambitny tekst o życiu</Heading>
            </Banner>
            ...
            <Blockquote>
              “The simplest scale is a single note, and sticking with a single
              note draws more attention to other parameters, such as rhythm and
              inflection.”
            </Blockquote>
          </Card>
        </Box>
